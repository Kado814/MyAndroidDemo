...
public class SpannableStringBuilderActivity extends MyBaseActivity {
    ...
    private void mode2() {
        ...
        ForegroundColorSpan colorSpan = new ForegroundColorSpan(Color.parseColor("#009ad6"));
        spannableString.setSpan(colorSpan, 0, 7, Spannable.SPAN_EXCLUSIVE_INCLUSIVE);
    ...
    private void mode9() {
        ...
        ClickableSpan clickableSpan = new ClickableSpan() {
            ...
            public void onClick(View view) {
                Toast.makeText(SpannableStringBuilderActivity.this, "请不要点我", Toast.LENGTH_SHORT).show();
            }
        };
